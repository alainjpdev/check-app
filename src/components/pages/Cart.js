  ...
  return (
    <>
      ...
      <div className="margin-cart">
        <Car body={body} grill={grill} rollbar={rollbar} bumper={bumper} />
      </div>
      <div className="border-cart">
        <div className="shop-details-container">
          <ul>
            <li>
              Moke type:<strong> ELECTRIC</strong>
            </li>
            <li>
              Body color: <strong>{body.toUpperCase()}</strong>
            </li>
            <li>
              Bumper color: <strong>{bumper.toUpperCase()}</strong>
            </li>
            <li>
              Grill color: <strong>{grill.toUpperCase()}</strong>
            </li>
            <li>
              Rollbar color: <strong>{rollbar.toUpperCase()}</strong>
            </li>
